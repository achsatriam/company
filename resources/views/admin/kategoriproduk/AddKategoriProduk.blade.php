    ...
    <div class="row">
      ...
      <div class="col-xxl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{ url('kategori_produk') }}" method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label" for="basic-default-name">Jenis Kategori</label>
                  <div class="col-sm-10">
                      <input type="text" name="kategori_produk" class="form-control @error('kategori_produk') is-invalid @enderror" value="{{ old('kategori_produk') }}" id="kategori_produk" autofocus/>
